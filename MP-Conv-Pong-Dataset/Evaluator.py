#!/home/michael/anaconda3/envs/pytorch/bin/python
...
def main():
    ...
    #Start workers
    workers = [Worker(envs[i], epoch_size, model, criterion, optimizer, reward_queue, str(i+1)) for i in range(worker_count)]
